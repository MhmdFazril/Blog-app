    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/posts/{{ $post->slug }}" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control d-none" id="slug" name="slug"
                    value="{{ old('slug', $post->slug) }}">
                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slugDisplay"
                    name="slugDisplay" disabled readonly required value="{{ old('slug', $post->slug) }}">
                @error('slug')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                @if ($post->image)
                    ...
                    col-sm-5 d-block" id="img-preview">
                @else
